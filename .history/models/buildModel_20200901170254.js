...
const calcul = new Schema({
    ...
    health_occurence: { type: Number }, // Maximum Health, Healing taken
    ...
    buff_occurence: { type: Number }, // Expedition, Berserk, Slayer, Protection, Evasion, Mending, Heroism, Vitality, Aegis, Speed ....
    group_occurence: { type: Number }, // group
    dungeon_occurence: { type: Number }, // Dungeon
})
