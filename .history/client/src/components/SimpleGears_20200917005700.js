...
const SimpleGears = (props) => {
    ...
    return (
        <div className="col-8 mt-2">
            <div className="row">
                <svg className="mx-auto d-block" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
