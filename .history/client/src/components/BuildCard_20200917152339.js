    ...
    return (
        ...
        <div className="card text-white col-3 m-2">
            ...
            <div className="row mx-auto">
                {props.noEdit ? <button className="m-1 badge badge-pill badge-dark text-white" onClick={() => { editBuild(props.build) }} >Edit</button> : <></>}
                {/* <Chip className="m-1" label="Share" size="small" color="secondary"
                // onClick={() => { shareBuild(props.build) }} 
                /> */}
                {props.noEdit ? <button className="m-1 badge badge-pill badge-dark text-white" onClick={() => { confirmAction(props.build) }} >Delete</button> : <></>}
