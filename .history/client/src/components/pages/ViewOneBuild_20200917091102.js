    ...
    return (
        ...
        < div >
            ...
            <div className="row mx-auto">
                <img className="classImg col-lg-4 col-md-4 col-sm-2" src={build.iclass ? require(`../../utils/images/${build.iclass}.png`) : "https://www.eso-gold.com/images/game_left/the-elder-scrolls-online.png"} style={imgStyle} />
