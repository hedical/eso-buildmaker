        ...
        < div >
            ...
            <div className="row">
                ...
                <div id="chart" className="col-lg-3 col-sm-12 col-xs-12">
                    ...
                    <Chart options={graphSustain.options} series={graphSustain.series} type="radar" height={200} />
                    {/* </div> */}
                    {/* <div id="chart" className="col-lg-3 col-sm-12 col-xs-12"> */}
                    <h2>Damage Analysis</h2>
                    <Chart options={graphDamage.options} series={graphDamage.series} type="radar" height={200} />
                </div>
            </div>
            <Footer></Footer>
        </ div >
