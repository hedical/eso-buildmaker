        ...
        <div>
            ...
            < div className="container" >
                ...
                <div className="row col-9 offset-1 mb-1">
                    <Tooltip piece="head" title={(e) => retreiveSetInfo(e.target.piece)} classes={{ tooltip: classes.customWidth }} placement="bottom" id="head">
                ...
                <div className="row col-9 mb-1">
                    <Tooltip title={"Chose a set"} classes={{ tooltip: classes.customWidth }} placement="bottom">
                        <div className="card-group col-2">
                            <img src={require("../../utils/images/shoulder.png")} className="card-img" alt={""} />
