                ...
                <article className="card" role="article">
                    <a href="#">
                        <div className="card-text">
                            ...
                            <h2 className="card-title">A Photographer’s Weekend House By General Design</h2>
                        </div>
                        <img className="card-image" src="http://www.ignant.de/wp-content/uploads/2016/02/Frederiksvej-Kindergarten_07_credit-Rasmus-Hjortsh%C3%B8j-COAST-Studio.jpg" />
                    </a>
                </article>
            </div>
