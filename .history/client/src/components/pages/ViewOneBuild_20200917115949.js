    ...
    return (
        ...
        < div >
            ...
            <div className="row">
                ...
                {gears.chest ?
                    < div className="container col-lg-2 col-md-6 col-sm-12 m-0" >
                        <h2>Gears</h2>
