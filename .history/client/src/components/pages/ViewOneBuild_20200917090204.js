    ...
    return (
        ...
        < div >
            ...
            <div className="row mx-auto">
                <img className="classImg col-lg-4 col-md-4 col-sm-2" src={iclass ? require(`../../utils/images/${build.class}.png`) : "https://www.eso-gold.com/images/game_left/the-elder-scrolls-online.png"} style={imgStyle} />
