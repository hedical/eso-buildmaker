                ...
                <div className="row col-9 offset-1 mb-1">
                    <div className="card-group col-2">
                        ...
                        <ReactTooltip id='head' className='custom-color-no-arrow' delayHide={500}
                            textColor='#eeca2a' backgroundColor='#222' effect='solid' aria-haspopup='true'>
                            <h2 >{gears.head.set.name}</h2>
                            <ul>
                                <li>{gears.head.set.bonus_item_1 ? `(1 item) ${gears.head.set.bonus_item_1}` : ""}</li>
                                <li>{gears.head.set.bonus_item_2}</li>
                                <li>{gears.head.set.bonus_item_3}</li>
                                <li>{gears.head.set.bonus_item_4}</li>
                                <li>{gears.head.set.bonus_item_5}</li>
                            </ul>
                        </ReactTooltip>
                    </div>
                </div>
