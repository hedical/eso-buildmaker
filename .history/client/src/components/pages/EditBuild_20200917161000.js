                            ...
                            <div className="col-lg-3 col-xs-12">
                                <FormControl className={clsx(classes.margin, classes.withoutLabel, classes.textField)}>
                                    ...
                                    <Input
                                        id="magicka"
                                        // value={stats.magicka}
                                        defaultValue={build.stats.magicka ? build.stats.magicka : 0}
                                        color="info"
                                ...
                                <FormControl className={clsx(classes.margin, classes.withoutLabel, classes.textField)}>
                                    ...
                                    <Input
                                        id="stamina"
                                        // value={stats.stamina}
                                        defaultValue={build.stats.stamina ? build.stats.stamina : 0}
                                        color="primary"
                                ...
                                <FormControl className={clsx(classes.margin, classes.withoutLabel, classes.textField)}>
                                    ...
                                    <Input
                                        id="health"
                                        // value={stats.health}
                                        defaultValue={build.stats.health ? build.stats.health : 0}
                                        color="secondary"
