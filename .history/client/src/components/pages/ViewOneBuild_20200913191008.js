...
const ViewOneBuild = () => {
    ...
    const [gears, setGears] = useState([{ head: "" }])
    ...
    const getBuildInfo = async () => {
        await axios
            ...
            .then((build) => setBuild(build.data))
        // .then((build1) => {
        //     console.log("first build", build1);
        //     console.log("first build", build);
        //     gearsMap(build)
        // })
    }
            ...
            < div className="container" >
                ...
                <div className="row col-9 offset-1 mb-1">
                    ...
                    <div className="card-group col-2">
                        ...
                        {/* <ReactTooltip id='getContent' getContent={gears.head.set} /> */}
                    </div>
                    {/* </Tooltip> */}
                </div>
