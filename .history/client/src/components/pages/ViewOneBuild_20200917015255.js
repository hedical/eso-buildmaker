...
const ViewOneBuild = () => {
    ...
    const [calcul, setCalcul] = useState({
        magicka_occurrence, // Maximum Magicka
        health_occurence, // Maximum Health, Healing taken, Health
        stamina_occurence, // Maximum Stamina
        weapon_damage_occurence, // Weapon Damage
        spell_damage_occurence, // Spell Damage
        stam_reco_occurence, // Stamina Recovery
        mag_reco_occurence, // Magicka Recovery
        health_reco_occurence, // Health Recovery
    })
    ...
    const statCalculation = () => {
        build.gears.forEach((gear) => {
            gear.set.forEach((bonus) => {
                bonus.includes('Maximum Magicka') ?
    })
        })
    }
