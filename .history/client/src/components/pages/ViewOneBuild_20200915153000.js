                ...
                < div className="container" >
                    ...
                    <div className="row col-9 mb-1">
                        <div className="card-group col-2">
                            ...
                            <ReactTooltip id='shoulder' className='custom-color-no-arrow'
                                textColor='#eeca2a' backgroundColor='#222' effect='solid' border={true} borderColor='white' place={'top'} type={'light'} multiline={true} width="180px" height="40px">
                        ...
                        <div className="card-group col-2 offset-2 p-0">
                            ...
                            <ReactTooltip id='chest' className='custom-color-no-arrow'
                                textColor='#eeca2a' backgroundColor='#222' effect='solid' border={true} borderColor='white' place={'top'} type={'light'} width="180px" height="40px">
