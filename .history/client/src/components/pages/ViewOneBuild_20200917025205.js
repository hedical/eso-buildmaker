    ...
    const statCalculation = () => {
        ...
        build.gears.forEach((gear) => {
            ...
            stringToAnalyze.forEach((bonus) => {
                ...
                if (typeof bonus == "string" && bonus.includes('Physical and Spell Penetration' || 'Physical Penetration')) {
                    physicalPen++
                }
                if (typeof bonus == "string" && bonus.includes('Physical and Spell Penetration' || 'Spell Penetration')) {
                    spellPen++
                }
                if (typeof bonus == "string" && bonus.includes('Weapon and Spell Damage' || 'Weapon Damage')) {
                    weaponDamage++
                }
                if (typeof bonus == "string" && bonus.includes('Weapon and Spell Damage' || 'Spell Damage')) {
                    spellDamage++
                }
                if (typeof bonus == "string" && bonus.includes('Weapon and Spell Critical') || bonus.includes('Weapon Critical')) {
                    weaponCritical++
                }
                if (typeof bonus == "string" && bonus.includes('Weapon and Spell Critical' || 'Spell Critical')) {
                    spellCritical++
                }
            })
        })
