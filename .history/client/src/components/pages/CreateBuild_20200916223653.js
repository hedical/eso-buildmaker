    ...
    return (
        <ThemeProvider theme={theme}>
            <div>
                ...
                <div className="container ml-0 mb-3">
                    ...
                    <div className="row">
                        <CSSTransition
                            ...
                            unmountOnExit
                        >
                            <img className="col-lg-4 col-md-4 col-sm-2" src={iclass ? require(`../../utils/images/${iclass}.png`) : "https://www.eso-gold.com/images/game_left/the-elder-scrolls-online.png"} style={imgStyle} />
