...
const ViewOneBuild = () => {
    ...
    return (
        <div>
            <Jumbo text={build.title} action="Create a new build" link="/create-build" />


            < div className="container" >

                <div className="row col-9 offset-1 mb-1">
                    <Tooltip piece="head" title={(e) => { retreiveSetInfo(e.target.getAttribute("piece")) }} classes={{ tooltip: classes.customWidth }} placement="bottom">
                ...
                <div className="row col-9 mb-1">
                    <Tooltip title={"ho"} classes={{ tooltip: classes.customWidth }} placement="bottom" piece="chest">
                        <div className="card-group col-2">
                            <img src={require("../../utils/images/shoulder.png")} className="card-img" alt={"alt"} />
