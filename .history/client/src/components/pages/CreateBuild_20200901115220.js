...
const CreateBuild = () => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVmNGFiMTM3OTMxYmIyNTU1MTZhYWQ2ZCIsImlhdCI6MTU5ODc0MjY0NX0.SWLywyyh4sHerU2m09h4kOyc7JKTs3DxMkZm8auqZaI"
    const save = async (e) => {
        e.preventDefault();
        ...
        try {
            ...
            await axios.post(
                ...
                newBuild, {
                headers: {
                    'x-auth-token': "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVmNGFiMTM3OTMxYmIyNTU1MTZhYWQ2ZCIsImlhdCI6MTU5ODc0MjY0NX0.SWLywyyh4sHerU2m09h4kOyc7JKTs3DxMkZm8auqZaI"
                }
            });
