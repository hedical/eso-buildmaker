                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-3 col-xs-12">
                                <FormControl className={clsx(classes.margin, classes.withoutLabel, classes.textField)}>
                                    <Input
                                        id="magicka"
                                        value={build.stats.magicka}
                                        defaultValue={build.stats.magicka}
                                        color="info"
                                    ...
                                    <Input
                                        id="stamina"
                                        value={build.stats.stamina}
                                        defaultValue={build.stats.stamina}
                                        color="primary"
                                    ...
                                    <Input
                                        id="health"
                                        value={build.stats.health}
                                        defaultValue={build.stats.health}
                                        color="secondary"
