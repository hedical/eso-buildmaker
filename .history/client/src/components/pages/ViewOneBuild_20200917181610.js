...
const ViewOneBuild = () => {
    ...
    return (
        ...
        < div >
            ...
            <div className="row">
                <div className="mt-3" style={{ "border-bottom": '1px solid' }}>
                    <h2 >Main Sets</h2>
                    {checkForUniqueSets().map((set, id) => (
                        <li key={id}><h5>
                            {set}
                        </h5>
                ...
                {gears.chest ?
                    < div className="container col-lg-3 col-md-6 col-sm-12 m-0" >
                        <h2>Gears</h2>
                ...
                <div id="chart" className="col-lg-3 col-sm-12 col-xs-12">
                    <h2>Sustain analysis</h2>
                    <Chart options={graphSustain.options} series={graphSustain.series} type="radar" height={300} />
                    {/* </div> */}
                    {/* <div id="chart" className="col-lg-3 col-sm-12 col-xs-12"> */}
                    <h2>Damage Analysis</h2>
                    <Chart options={graphDamage.options} series={graphDamage.series} type="radar" height={300} />
                </div>
            </div>
            <Footer></Footer>
        </ div >
