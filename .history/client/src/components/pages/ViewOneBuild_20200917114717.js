    ...
    return (
        ...
        < div >
            ...
            <div className="row">
                ...
                {gears.chest ?
                    < div className="container col-3 m-0" >
                        <h2>Gears</h2>
                        <div className="row col-12 mb-1">
                            <div className="card-group offset-1 col-4">
                        ...
                        <div className="row col-12 mb-1">
                            ...
                            <div className="card-group col-4 offset-2 p-0">
                                <MyTooltip setInfo={gears.chest} piece='chest' />
                            </div>
                        </div>
                        <div className="row col-2 mb-1">
                            <div className="card-group col-12">
                                <MyTooltip setInfo={gears.hands} piece='hands' />


                            </div>
                            <div className="card-group col-12 offset-2 p-0">
