                ...
                < div className="container" >
                    ...
                    <div className="row col-9 offset-1 mb-1">
                        <div className="card-group col-2">
                            ...
                            <ReactTooltip id='head' className='custom-color-no-arrow' delayHide={500}
                                textColor='#eeca2a' backgroundColor='#222' effect='solid' border={true} borderColor='white' place={'top'} type={'light'} width={'500px'}>
                    ...
                    <div className="row col-9 mb-1">
                        <div className="card-group col-2">
                            ...
                            <ReactTooltip id='shoulder' className='custom-color-no-arrow' delayHide={500}
                                textColor='#eeca2a' backgroundColor='#222' effect='solid' borderColor='yellow'>
