...
const SimpleGears = (props) => {
    ...
    return (
        <div className="col-8 mt-2">
            <div className="row">
                <svg className="mx-auto" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="row col-12 offset-1 mb-1">
                        <div className="card-group col-2">
                            <img src={require("../utils/images/head.png")}
                                className="card-img"
                                style={finaleGear.piece === this.id ? imgStyle : ""}
                                id="head"
