...
export default function ImgMediaCard(props) {
    ...
    return (
        ...
        <div className="card text-white col-3 m-2">
            <img className="card-img" src={props.build.iclass ? require(`../utils/images/${props.build.iclass}Card.png`) : "https://images.mmorpg.com/images/heroes/news/43780.jpg"} style={imgStyle} alt="Card image" />
